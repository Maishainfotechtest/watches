...
<div class="main-container container">
    ...
    <div class="row">
                ...
                <div class="left-content-product">
                    <div class="content-product-left class-honizol col-md-5 col-sm-12 col-xs-12">
                        <div class="large-image  ">
                            <img itemprop="image" class="product-image-zoom"
                                src=" https://staticimg.titan.co.in/Titan/Catalog/1833WL01_1.jpg?pView=pdp"
                                data-zoom-image=" https://staticimg.titan.co.in/Titan/Catalog/1833WL01_1.jpg?pView=pdp"
                        ...
                        <div id="thumb-slider" class="yt-content-slider full_slider owl-drag" data-rtl="yes"
                            ...
                            <a data-index="0" class="img thumbnail "
                                data-image="https://staticimg.titan.co.in/Titan/Catalog/1833WL01_1.jpg?pView=pdp"
                                title="Chicken swinesha">
                                <img src="https://staticimg.titan.co.in/Titan/Catalog/1833WL01_3.jpg?pView=thumb"
                                    title="Chicken swinesha" alt="Chicken swinesha">
                            </a>
                            <a data-index="1" class="img thumbnail "
                                data-image=" https://staticimg.titan.co.in/Titan/Catalog/1833WL01_5.jpg?pView=pdp"
                                title="Chicken swinesha">
                                <img src="https://staticimg.titan.co.in/Titan/Catalog/1833WL01_5.jpg?pView=pdp"
                                    title="Chicken swinesha" alt="Chicken swinesha">
                            </a>
                            <a data-index="2" class="img thumbnail "
                                data-image="https://staticimg.titan.co.in/Titan/Catalog/1833WL01_4.jpg?pView=pdp"
                                title="Chicken swinesha">
                                <img src="https://staticimg.titan.co.in/Titan/Catalog/1833WL01_4.jpg?pView=thumb"
                                    title="Chicken swinesha" alt="Chicken swinesha">
                            </a>
                            <a data-index="3" class="img thumbnail "
                                data-image=" https://staticimg.titan.co.in/Titan/Catalog/1833WL01_6.jpg?pView=pdp"
                                title="Chicken swinesha">
                                <img src="https://staticimg.titan.co.in/Titan/Catalog/1833WL01_6.jpg?pView=thumb"
                                    title="Chicken swinesha" alt="Chicken swinesha">
                            </a>
                            <a data-index="4" class="img thumbnail "
                                data-image=" https://staticimg.titan.co.in/Titan/Catalog/1833WL01_3.jpg?pView=pdp"
                                title="Chicken swinesha">
                                <img src="https://staticimg.titan.co.in/Titan/Catalog/1833WL01_3.jpg?pView=thumb"
                                    title="Chicken swinesha" alt="Chicken swinesha">
                            </a>
                    ...
                    <div class="content-product-right col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="stock">
                            ...
                            <span class="code-product">product code : sku-17894-3856</span>
                        </div>

                        <div class="short_description form-group">
                            Your Stand, Move, and Exercise rings show you how active you are every day and can inspire
                            you to move a little more to close them. Ask Siri to show you if you’ve been sitting too
                            much. Track how many steps you’ve taken and how many calories you’ve burned. And aim for 30
                            minutes of exercise, even if it’s not all at once. Share and compare your Activity rings
                            with friends and family to stay motivated or compete to see who can close their rings first.
                        </div>
                        <div id="product">
        ...
        <aside class="col-sm-4 col-md-3 content-aside" id="column-left">
            <div class="trande">
                <h3>
                    <img src="image/theme/icons/trande.png" alt="">
            ...
            <div class="policy-product">
                <ul>
                    ...
                    <li>
                        <div class="policy">
                            <div class="icon"><i class="fa fa-gift"></i></i></div>
                            <div class="policy-info">
                ...
                <div class="modcontent">
                    <div class="so-extraslider">
                        ...
                        <div class="yt-content-slider extraslider-inner products-list" data-rtl="yes"
                            data-pagination="yes" data-autoplay="no" data-delay="4" data-speed="0.6" data-margin="30"
                            ...
                            <div class="item ">
                                <div class="product-layout item-inner style1   ">
                                    <div class="item-image">
                                        <div class="item-img-info transition ">
                                    ...
                                    <div class="item-info">
                                        ...
                                        <div class="item-title">
                                            ...
                                            <div class="col-lg-6">
                                              <button type="button" class="addToCart btn-button customcss" title="Add to cart"
                                               onclick="cart.add('60 ');"> <i class="fa fa-shopping-basket"></i>
                                               Add to cart  
                                               </button> <button type="button" class="wishlist btn-button  wishlistcustom" title="Add to Wish List"
                                                onclick="wishlist.add('60');"><i class="fa fa-heart"></i> Add To Wish
                                                List </button>
                                            </div>
                                    <!-- End item-info -->
                                    <!-- End item-wrap-inner -->
                                    ...
                                    <div class="item-image">
                                        <div class="item-img-info">
                                            <a href="#" target="_self" title="Xancetta bresao ">
                                                <img src="https://staticimg.titan.co.in/Titan/Catalog/1828QL03_1.jpg?pView=listing"
                                                    alt="Xancetta bresao">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item-image">
                                        <div class="item-img-info ">
                                            <a href="#" target="_self" title="Sausage cowbee ">
                                                <img src="https://staticimg.titan.co.in/Titan/Catalog/1846KM01_1.jpg?pView=listing"
                                                    alt="Sausage cowbee">
                                                   </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item-image">
                                        <div class="item-img-info">
                                            <a href="#" target="_self" title="Chicken swinesha ">
                                                <img src="https://staticimg.titan.co.in/Titan/Catalog/1847KM02_1.jpg?pView=listing"
                                    ...
                                    <div class="item-image">
                                        <div class="item-img-info">
                                            <a href="#" target="_self" title="Qeserunt shortloin ">
                                                <img src="https://staticimg.titan.co.in/Fastrack/Catalog/38053PM01_1.jpg?pView=listing"
                                    ...
                                    <div class="item-image">
                                        <div class="item-img-info">
                                            <a href="#" target="_self" title="Consecte quichuck ">
                                                <img src="http://via.placeholder.com/80x80?6.jpg"
                                    ...
                                    <div class="item-image">
                                        <div class="item-img-info">
                                            <a href="#" target="_self" title="Neatball bresaola ">
                                                <img src="http://via.placeholder.com/80x80?7.jpg"
                                    ...
                                    <div class="item-image">
                                        <div class="item-img-info">
                                            <a href="#" target="_self" title="Yutculpa ullamco ">
                                                <img src="http://via.placeholder.com/80x80?8.jpg"
            ...
            <div id="so_listing_tabs_3" class="so-listing-tabs first-load">
                ...
                <div class="ltabs-wrap">
                    <div class="ltabs-tabs-container" data-rtl="yes" data-delay="300" data-duration="600"
                        data-effect="starwars" data-ajaxurl="" data-type_source="0" data-lg="5" data-md="4" data-sm="2"
                        ...
                        <div class="ltabs-tabs-wrap">
                            ...
                            <ul class="ltabs-tabs cf list-sub-cat font-title">
                                <li class="ltabs-tab tab-sel" data-category-id="61"
                                    data-active-content=".items-category-61"><span class="ltabs-tab-label">RELATED
                                        PRODUCTS</span></li>
                                <li class="ltabs-tab  " data-category-id="67" data-active-content=".items-category-67">
                                    <span class="ltabs-tab-label">Upsell products</span></li>
                    ...
                    <div class="wap-listing-tabs ltabs-items-container products-list grid">
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Pastrami bacon">
                                                        <img src="https://staticimg.titan.co.in/Sonata/Catalog/77070PP10_1.jpg?pView=listing"
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Chicken swinesha">
                                                        <img src="https://staticimg.titan.co.in/Sonata/Catalog/77070PP11_1.jpg?pView=listing"
                                                            class="img-1 img-responsive" alt="image">
                                                        <img src=" https://staticimg.titan.co.in/Sonata/Catalog/77070PP11_1.jpg?pView=listing"
                                                            class="img-2 img-responsive" alt="image">
                                                    </a>
                                                </div>
                                                <div class="box-label"> <span class="label-product label-sale"> -16%
                                                    </span></div>
                                                <div class="button-group so-quickview cartinfo--left">
                                                    <button type="button" class="addToCart btn-button"
                                                        title="Add to cart" onclick="cart.add('60 ');"> <i
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                        <img src="https://staticimg.titan.co.in/Titan/Catalog/114101012SQ_1.jpg?pView=listing"
                                                            class="img-1 img-responsive" alt="Pastrami bacon">
                                                        <img src="https://staticimg.titan.co.in/Titan/Catalog/114101012SQ_1.jpg?pView=listing"
                                                            class="img-2 img-responsive" alt="Pastrami bacon">
                                                    </a>
                                                </div>
                                                <div class="box-label"> <span class="label-product label-new"> New
                                                    </span></div>
                                                <div class="button-group so-quickview cartinfo--left">
                                                    <button type="button" class="addToCart btn-button"
                                                        title="Add to cart" onclick="cart.add('60 ');"> <i
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Sausage cowbee">
                                                        <img src="https://staticimg.titan.co.in/Titan/Catalog/1843SM01_1.jpg?pView=listing"
                                                            class="img-1 img-responsive" alt="image">
                                                        <img src="https://staticimg.titan.co.in/Titan/Catalog/1843SM01_1.jpg?pView=listing"
                                                            class="img-2 img-responsive" alt="image">
                                                    </a>
                                    ...
                                    <div class="item-inner product-layout transition product-grid">
                                        <div class="product-item-container">
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                        <img src="https://staticimg.titan.co.in/Titan/Catalog/1847KL01_1.jpg?pView=listing"
                                                            class="img-1 img-responsive" alt="Pastrami bacon">
                                                        <img src="https://staticimg.titan.co.in/Titan/Catalog/1847KL01_1.jpg?pView=listing"
                                                            class="img-2 img-responsive" alt="Pastrami bacon">
                                                    </a>
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Balltip nullaelit">
                                                        <img src="http://via.placeholder.com/320x320?6.jpg"
                                                            class="img-1 img-responsive" alt="image">
                                                        <img src="http://via.placeholder.com/320x320?5.jpg"
                                                            class="img-2 img-responsive" alt="image">
                                                    </a>
                                                </div>
                                                <div class="box-label"> <span class="label-product label-new"> New
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Lamboudin ribeye">
                                                        <img src="http://via.placeholder.com/320x320?7.jpg"
                                                            class="img-1 img-responsive" alt="image">
                                                        <img src="http://via.placeholder.com/320x320?4.jpg"
                                                            class="img-2 img-responsive" alt="image">
                                                    </a>
                                                </div>
                                                <div class="button-group so-quickview cartinfo--left">
                        ...
                        <div class="ltabs-items items-category-67 grid" data-total="10">
