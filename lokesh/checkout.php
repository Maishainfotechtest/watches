...
<div class="main-container container">
	...
	<div class="row">
       ...
       <!--customer login -->
			...
			<!--customer login -->	
			<div class="col-right col-lg-9 col-sm-9">
		<div class="row">
			<!-- delivery method -->
			<div class="col-lg-6 col-sm-12">
				<div class="panel panel-default no-padding">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title"><i class="fa fa-user"></i> Billing Details</h4>
						</div>
						<div class="panel-body">
							<fieldset id="account">
			...
			<div class="col-lg-6 col-sm-12">
				...
				<div class="panel-heading">
					...
					<div class="panel panel-default">
						<div class="col-lg-12 col-sm-6">
							<div class="col-lg-12 col-sm-6  checkout-payment-methods">
								<div class="panel-heading">
